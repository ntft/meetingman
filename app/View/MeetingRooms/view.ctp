...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Meeting Room'), array('action' => 'delete', $meetingRoom['MeetingRoom']['id']), array(), __('Are you sure you want to delete # %s?', $meetingRoom['MeetingRoom']['id'])); ?> </li>
...
<div class="related">
	...
	<?php foreach ($meetingRoom['Meeting'] as $meeting): ?>
		<tr>
			...
			<td><?php echo $meeting['gijiroku']; ?></td>
			<td class="actions">
				...
				<?php echo $this->Form->postLink(__('Delete'), array('controller' => 'meetings', 'action' => 'delete', $meeting['id']), array(), __('Are you sure you want to delete # %s?', $meeting['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
